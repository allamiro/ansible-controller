...
Historical development and audit notes, preserved for traceability. Statements
about missing features or lab teardown describe their original test sessions.
For current support and evidence, read [VERIFICATION.md](../../../gitlab/VERIFICATION.md).
...
Machine-readable sanitized results are in [tests/evidence.json](../../../gitlab/tests/evidence.json).
Raw traces, CA files and credentials remain under the gitignored `tests/.state`.
See [test instructions](../../../gitlab/tests/README.md) for reproducible commands.
