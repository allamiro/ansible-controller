...
You need Docker Engine, Docker Compose V2, Git, and OpenSSH tools on the host. Run these commands from the repository root. Replace `192.0.2.10` and `deploy` with your server and SSH account.
